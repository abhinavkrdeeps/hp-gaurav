...
<td>order.getCustomer().getFirstCusName()</td>
<td>
<select name="deliveryperson">
<c:forEach items="${deliverypersons}" var="deliveryperson">

<option value="${deliveryperson. getDeliverypersonId()}">${deliveryperson.getFirstName() }</option>
</td>
</c:forEach>

<td>
</select>
<a href="assign/${order.getOrderId()}">Assign Order</a>
</td>
</tr>
</c:forEach>
